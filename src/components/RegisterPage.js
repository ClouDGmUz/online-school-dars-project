...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <Card className="w-full max-w-md relative z-10 animate-slide-up mt-8 mb-8">
        ...
        <CardFooter className="justify-center text-sm text-slate-400 border-t border-white/5 pt-6 mt-2">
          ...
          <Link to="/login" className="font-medium text-brand-400 hover:text-brand-300 hover:underline transition-colors">
            Sign in
          </Link>
        </CardFooter>
      </Card>
